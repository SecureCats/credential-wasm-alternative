...
impl Priv {
    fn new(e: &String) -> Priv {
        let mut p = Priv {
            rs: BigInt(gen_random_32()),
            re: BigInt(gen_random_32()),
            rw: BigInt(gen_random_32()),
            rz: BigInt(gen_random_32()),
            rx: BigInt(gen_random_32()),
            w: BigInt(gen_random_32()),
            r: BigInt(gen_random_32()),
            rn: [BigInt(gen_random_32()); 20],
            r_: Default::default(),
            z: Default::default(),
...
pub fn greet(s: &str, e: &str, v: &str, uk: &str, a: &str, b: &str, g: &str, h: &str, n: &str, exp: &str, gamma: &str, course_id: &str) -> String {
    ...
    params.y2 = base(&pr.rn[1], &pr.rn[3]);
...
//    params.z3 = &pr.rn[3] + &params.x * &pr.re;
    ...
    params.y3 = (_exp(&a, &pr.rn[4], &b, &pr.rn[5], &m) *
